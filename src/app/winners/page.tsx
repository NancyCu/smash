                                    ...
                                    <div className="flex flex-col gap-2 items-center md:items-end">
                                        {res.winners?.map((w, idx) => (
                                            <div key={idx} className="flex items-center gap-3 bg-black/30 px-4 py-2 rounded-xl border border-white/5">
                                                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 flex items-center justify-center font-bold text-xs text-white">{w.displayName?.[0]}</div>
